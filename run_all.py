...
from .models import get_model, remove_dropout_layers
from .train import train_one_epoch
from .eval import accuracy, pgd_accuracy, evaluate_attribution_metrics, evaluate_faithfulness, append_csv
from .plots import save_curve_plot
...
def main():
    ...
    if args.mode == "main":
        ...
        from .attributions import blurred_baseline, integrated_gradients, ads_baseline
        from .attributions import attribution_entropy
        import torch
