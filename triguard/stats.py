...
def _setting_label(values: dict) -> str:
    names = {
        ...
        "triguard_ig_steps": "train_ig",
        "reference_pair_samples": "pairs",
        "reference_bank_samples": "train_refs",
        "eval_reference_bank_samples": "eval_refs",
        "regularizer_microbatch": "reg_microbatch",
        "vectorized_reference_ig": "vectorized_ig",
        "checkpoint_regularizer_ig": "checkpoint_ig",
        "sampled_mass_penalty": "sampled_mass",
        "preload_reference_banks": "preload_banks",
